  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const payload = {
        ...
        images: imagesPayload, // NEW: Include images in the same request
      };
      ...
      <>
        ...
        <div className="container" style={{ paddingTop: '3rem', paddingBottom: '4rem', maxWidth: '700px' }}>
          <div style={{ marginBottom: '2rem' }}>
            <div style={{ width: '200px', height: '40px', backgroundColor: 'var(--color-bg-secondary)', borderRadius: 'var(--radius-md)' }} />
          </div>
          <div style={{ height: '400px', backgroundColor: 'var(--color-bg-secondary)', borderRadius: 'var(--radius-lg)' }} />
        </div>
        <Footer />
      </>
    );
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Card padding="lg" style={{ marginBottom: '1.5rem' }}>
            ...
            <p style={{ fontSize: 'var(--font-size-sm)', color: 'var(--color-text-secondary)', marginBottom: '1rem' }}>
              Upload high-quality photos of your property. The first image will be used as the cover photo. You can reorder images and change the cover photo after uploading.
            </p>
            <ImageUploader
              images={images}
            ...
            />
            {fieldErrors.images && (
              <p style={{ color: 'var(--color-error)', fontSize: 'var(--font-size-xs)', marginTop: '0.5rem' }}>
                {fieldErrors.images}
              </p>
            )}
          </Card>
